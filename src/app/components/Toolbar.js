    ...
    return (
      <div>
        <Menu theme="light" mode="horizontal" style={{ lineHeight: '64px' }} selectable={false}>
          ...
          <Menu.Item key="2"><Button size={'large'} loading={this.props.isBuilding} onClick={this.props.onBuildProject}>Build&amp;Run</Button></Menu.Item>
          <Menu.Item key="3"><Button size={'large'} onClick={this.props.onOpenEmulator}>Emulator</Button></Menu.Item>
        </Menu>
      </div>
    )
  }
